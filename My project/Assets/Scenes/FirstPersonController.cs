...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void BreathingEffect()
    {
        ...
        float smoothChange = Mathf.SmoothStep(0f, translateChange, 0.5f); // SmoothStep for smoother breathing effect
        Camera.main.transform.localPosition = originalPosition + new Vector3(0f, smoothChange, 0f);
    }
    ...
    private void BobbingEffect()
    {
        ...
        float sprintMultiplier = isSprinting ? 2f : 1f;
        float smoothChange = Mathf.Lerp(0f, translateChange * sprintMultiplier, 0.5f); // Lerp for smoother bobbing effect
        Camera.main.transform.localPosition = originalPosition + new Vector3(0f, smoothChange, 0f);
    }
    ...
    public void toggleBobbing()
    {
        ...
        movementSpeed = isCameraEffectEnabled ? originalMovementSpeed * 10 : originalMovementSpeed / 10;
    }
}